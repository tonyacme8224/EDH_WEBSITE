        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-slate-800/80">
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <div className="bg-slate-900 p-4 rounded-2xl border border-slate-800 space-y-2 text-[11px] text-slate-300 leading-relaxed">
              ...
              <div><strong className="text-slate-400">대표 이메일:</strong> <a href="mailto:everyday.holidays.sg@gmail.com" className="text-blue-400 hover:underline">everyday.holidays.sg@gmail.com</a></div>
              <div><strong className="text-slate-400">WhatsApp 실시간 상담:</strong> <a href={getWhatsAppLink()} target="_blank" rel="noopener noreferrer" className="text-emerald-400 font-bold hover:underline">WhatsApp 1:1 바로가기</a></div>
            ...
            <div className="flex items-center gap-2 pt-1">
              ...
              <a
                href="mailto:everyday.holidays.sg@gmail.com?subject=%5BEveryday%20Holidays%5D%20B2B%20%EC%83%81%EB%8B%B4%20%EB%AC%B8%EC%9D%98"
